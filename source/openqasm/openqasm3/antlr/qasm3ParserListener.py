...
class qasm3ParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by qasm3Parser#hardwareQubitList.
    def enterHardwareQubitList(self, ctx:qasm3Parser.HardwareQubitListContext):
        pass

    # Exit a parse tree produced by qasm3Parser#hardwareQubitList.
    def exitHardwareQubitList(self, ctx:qasm3Parser.HardwareQubitListContext):
        pass
